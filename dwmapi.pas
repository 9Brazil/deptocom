...
const
  ...
  // [v. https://learn.microsoft.com/en-us/windows/win32/api/dwmapi/ne-dwmapi-dwm_window_corner_preference]
...
function DwmDefWindowProc; external ModName name 'DwmDefWindowProc'; stdcall;
function DwmEnableBlurBehindWindow; external ModName name 'DwmEnableBlurBehindWindow'; stdcall;
function DwmEnableComposition; external ModName name 'DwmEnableComposition'; stdcall;
function DwmEnableMMCSS; external ModName name 'DwmEnableMMCSS'; stdcall;
function DwmExtendFrameIntoClientArea; external ModName name 'DwmExtendFrameIntoClientArea'; stdcall;
function DwmGetColorizationColor; external ModName name 'DwmGetColorizationColor'; stdcall;
function DwmGetCompositionTimingInfo; external ModName name 'DwmGetCompositionTimingInfo'; stdcall;
function DwmGetWindowAttribute; external ModName name 'DwmGetWindowAttribute'; stdcall;
function DwmIsCompositionEnabled; external ModName name 'DwmIsCompositionEnabled'; stdcall;
function DwmModifyPreviousDxFrameDuration; external ModName name 'DwmModifyPreviousDxFrameDuration'; stdcall;
function DwmQueryThumbnailSourceSize; external ModName name 'DwmQueryThumbnailSourceSize'; stdcall;
function DwmRegisterThumbnail; external ModName name 'DwmRegisterThumbnail'; stdcall;
function DwmSetDxFrameDuration; external ModName name 'DwmSetDxFrameDuration'; stdcall;
function DwmSetPresentParameters; external ModName name 'DwmSetPresentParameters'; stdcall;
function DwmSetWindowAttribute; external ModName name 'DwmSetWindowAttribute'; stdcall;
function DwmUnregisterThumbnail; external ModName name 'DwmUnregisterThumbnail'; stdcall;
function DwmUpdateThumbnailProperties; external ModName name 'DwmUpdateThumbnailProperties'; stdcall;
function DwmSetIconicThumbnail; external ModName name 'DwmSetIconicThumbnail'; stdcall;
function DwmSetIconicLivePreviewBitmap(hwnd: HWND; hbmp: HBITMAP;
  var pptClient: TPoint; dwSITFlags: DWORD): HResult; external ModName name 'DwmSetIconicLivePreviewBitmap'; stdcall;
function DwmSetIconicLivePreviewBitmap(hwnd: HWND; hbmp: HBITMAP;
  pptClient: PPoint; dwSITFlags: DWORD): HResult; external ModName name 'DwmSetIconicLivePreviewBitmap'; stdcall;
function DwmInvalidateIconicBitmaps; external ModName name 'DwmInvalidateIconicBitmaps'; stdcall;
function DwmAttachMilContent; external ModName name 'DwmAttachMilContent'; stdcall;
function DwmDetachMilContent; external ModName name 'DwmDetachMilContent'; stdcall;
function DwmFlush; external ModName name 'DwmFlush'; stdcall;
//function DwmGetGraphicsStreamTransformHint; external ModName name 'DwmGetGraphicsStreamTransformHint'; stdcall;
//function DwmGetGraphicsStreamClient; external ModName name 'DwmGetGraphicsStreamClient'; stdcall;
//function DwmGetTransportAttributes; external ModName name 'DwmGetTransportAttributes'; stdcall;
